...
- **awnd** — background daemon managing concurrent PTY sessions, serves JSON-RPC 2.0 over WebSocket on `:7600`
...
internal/screen/   Snapshot and Cell types (the screen buffer model)
...
- `AWN_ADDR` — daemon address for the CLI (default: `ws://localhost:7600`)
